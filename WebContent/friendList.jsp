...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		...
		<div class="container">
			<a class="navbar-brand" href="/Project_test/index.jsp" style="color:black;">MBTI MATE</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto" >
					<li class="nav-item active" ><a class="nav-link" href="/Project_test/index.jsp"> 친구목록</a></li>
