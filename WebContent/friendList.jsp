				...
				.ajax({
					...
					success : function(result) {
						if (result.length != 0) {
							...
							$("#user_card_side2").attr("style", "display:none;");
							$("#user_card_side").attr("style", "style=");
							...
							$.each(result, function() {
								...
								copy.find("#uid").attr("href",
										"userInfo.jsp?u_id=" + this["u_id"])
								copy.find("#uid").text(this["u_name"]);
								copy.find("#uage").text(
										"(" + this["u_age"] + ")");
								copy.find("#ugender").text(this["u_gender"]);
								copy.find("#uloc")
										.text("주소 : " + this["u_loc"]);
								...
								copy.find("#utalent").text(
										"특기 : " + this["u_talent"]);
								copy.find("#umbti").text(this["u_mbti"]);
							...
							$("#user_card_side2")
									.attr("style",
											"justify-content: center;font-size: -webkit-xxx-large;color: black;");
							$("#user_card_side2").text("해당 MBTI 성향의 유저가 없습니다.");
							$("#user_card_side").attr("style", "display:none;");
						}
					},
	...
	<div class="container" style="margin-top: 10px;">
		<div class="row">
			...
			<div class="col-lg-10" style="margin-bottom: 50px;">
				<div id="carouselExampleIndicators" class="carousel slide my-4"
					...
					<div class="carousel-inner" role="listbox"
						...
						<div class="carousel-item active">
							<img src="logo\img0.png" style="max-width: 750px; height: 440px;"
								alt="Second slide">

						</div>
						<div class="carousel-item">
							<img src="logo\img01.png"
								style="max-width: 750px; height: 440px;" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img src="logo\img02.png"
								style="max-width: 750px; height: 440px;" alt="Second slide">
						</div>
					</div>
				...
				<div
					...
					<div class="alert alert-dismissible alert-warning">
						...
						<h2 class="alert-heading">
							<strong style="color: #343a40;"><%=list.get(0).getU_name()%>
								&nbsp;</strong>님의
						</h2>
					...
					<h4>
						궁합 별 &nbsp; <select name="selectBox" id="selectBox1"
				...
				<div class="row finterUL" id="user_card_side2" style="display:none;"></div>
